  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Programando la producción pecuaria
        p.mb-4 #[b Objetivo] Reforzar los conocimientos sobre planificación de la unidad pecuaria, con base en lo estudiado en el componente formativo.
